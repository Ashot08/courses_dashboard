...
<!--                            </div>-->
            ...
            <div class="cd__step_toggler_wrapper">
                <button class="cd__step_toggler">
                    ...
                    <button class="cd__program_save" data-action="cd__program_save">Создать Общую</button>
                    <button class="cd__program_separate_save"  data-action="cd__program_separate_save">Создать По Отдельности</button>
            </div>
        </div>
    </div>
